const waterFx3 = new Phaser.Class({
      ...
      Phaser.Renderer.WebGL.Pipelines.TextureTintPipeline.call(this, {
        ...
        fragShader: `
          ...
          void main( void ) {
            ...
            uv.x += (sin((uv.y + (time * 1.0)) * 2.0) * 0.001) + (sin((uv.y + (time * 0.2)) * 6.0) * 0.001);
            uv.y += (sin((uv.x + (time * 1.5)) * 2.0) * 0.005) + (sin((uv.x + (time * 0.2)) * 6.0) * 0.01);
